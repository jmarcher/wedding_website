...
export default {
  // Main hero
  wedding_date: "2. Januar 2021 | Finca Clara",
  reschedule_notice_title: 'Re Save The Date',
  reschedule_notice: 'Ohne euch möchten wir einfach nicht feiern! Daher verschieben wir schweren Herzens unsere Hochzeit um ein Jahr. Genaue Termine können wir euch leider noch nicht nennen. Wir melden uns aber, sobald wir neue Infos haben.',
...
Zum Schluss möchten wir schon einmal danke sagen. Für eure (angebotene) Unterstützung und das bisherige Mitfiebern. Wir sind schon ganz aufgeregt und freuen uns riesig, unsere Hochzeit mit unseren liebsten Menschen zu feiern!`,
  ...
  // Tabs
  tips_locations: "Orte",
  tips_restaurants: "Restaurants",
  tips_activities: "Unternehmungen",
  ...
  piriapolis_description:
    "Piriápolis ist eine Bucht im Bundesland Maldonado, gelegen zwischen Meer und Hügeln, die eine einzigartige Architektur für die Gegend zeigt.",
 ...
 zahlreiche Restaurants, die eine große Variation von schmackhaftem Fleisch auf dem traditionellen uruguayischen Holzkohlegrill zubereiten. Mit dem Besuch des 'Mercado del puerto' lässt sich ein Besuch der Altstadt von Montevideo verbinden.`,
  ...
  ciudad_vieja_description:
    "Die Altstadt von Montevideo ist der historische Stadtkern. Heutzutage ist es ebenfalls ein eigener Stadtteil. Die Altstadt ist geprägt von zahlreichen Firmenbüros, Ministerien sowie Bankgebäuden. Darüber hinaus prägen Museen, Kunstgalerien,  Kulturzentren sowie Restaurants, Diskotheken und Bars das Bild.",

  // La pedera
  la_pedrera: "La Pedrera",
  la_pedrera_description:
    "Die ersten 15 Tage im Januar verbingt ein Großteil der jungen Uruguayer ihren Sommer in La Pedrera. Hauptsächlich geht es ums Feiern. Fortgeschrittene Surfer*innen können den starken Wellengang der Gegend um La Pedrera genießen.",

  // Colonia del sacramento
  colonia_del_sacramento: "Colonia del Sacramento",
  colonia_del_sacramento_description:
    "Colonia del Sacramento ist eine historisch bedeutsame Stadt in Uruguay, gegründet durch die Portugiesen. Von Colonia del Sacramento aus, ist die argentinische Hauptstadt Buenos Aires täglich per Fähre sehr gut zu erreichen. Die Überfahrt dauert ca. 2 Stunden.",
  ...
  quebrada_de_los_cuervos_description:
    "Es handelt sich um eines von mehreren Naturschutzgebieten in Uruguay. Eine dreistündige Wanderung führt entlang der Schlucht. Es gibt auch eine Bademöglichkeit.",
  ...
  /////// ------------------ ////
  // Activities
  tristan_narvaja: "Flohmarkt 'Tristán Narvaja'",
  tristan_narvaja_description:
    "Tristan Narvaja ist ein riesiger Flohmarkt, der jeden Sonntag im Stadtteil Cordon stattfindet. Es lässt sich dort neben zahlreichen Überraschungen wirklich alles finden.",
  ...
  horse_riding_description:
    "Wenn du ein*e Pferdeliebhaber*n bist und dir ausreiten gefällt, findest du praktisch in jedem Badeort das Angebot für (Gruppen-)Ausritte am Stand. Mit oder ohne Guide, wie es dir am besten gefällt.",

  cerro_de_montevideo: "Cerro de Montevideo",
  cerro_de_montevideo_description:
    "Der Hügel hat eine Höhe von 135 Metern. Obenauf befindet sich die Festung von General Artigas, dessen Konstruktion wurde 1811 vollendet und war Schauplatz von historisch bedeutenden Momenten in der Geschichte von Uruguay. Die Festung beherbergt historischen Militärmuseum und den ersten Leuchtturm am Rio de la Plata. Hier hast du eine exzelente Aussicht über die Bucht von Montevideo.",

  keit: "Kitesurfen",
  keit_description: "Im Sommerxxxx ",

  museo_joaquin_torres_garcia: "Museo Joaquín Torres García",
  museo_joaquin_torres_garcia_description:
    "Joaquín Torres García ist der Erfinder des universellen Konstruktivismus. In Barcelona freundete er sich mit Antonio Gaudi an und entwarf mit ihm die Kirchenfenster der Kathedrale von Palma de Mallorca sowie die der Sagrada Familia.",

  museo_nacional_de_artes_visuales: "Museo nacional de artes visuales",
  museo_nacional_de_artes_visuales_description:
    "Es besitzt die größte Kollektion an Malerei und Skulpturen aus Uruguay, mit Stücken von Joaquín Torres García, Rafael Barradas, José Cuneo, Juan Manuel Blanes, um Einige zu nennen. Außerdem besitzt es Kunstwerke wichtiger Künstler*innen aus dem Ausland wie Pablo Picasso, Paul Klee, Goya, Eduardo Rosales, Pablo Serrano, um Einige zu nennen.",
  ...
  teatro_solis_description:
    "Enthüllt in 1856. Das Theater ist eine der wichtigsten Bühnen in Uruguay, es gibt Plätze für 1.500 Besucher*innen.",
  ...
  rambla_de_montevideo_description:
    "Die Rambla von Montevideo ist eine langlaufende Strasse (24 km), die die Küste des Río de la Plata eingrenzt. Die besten Spots liegen bei der Rambla República del Perú, Rambla Presidente Wilson y Rambla República de México, wo am Plaza de la Armada der beste Punkt für einen Sonnenuntergang ist.",
  ...
  experience_gaucho_description:
    "An verschiedenen Orten im Land sind kleine Landgüter zu finden, die du für einen Tag oder auch länger besuchen kannst, um die Kultur der Gauchos kennenzulernen.",

  wine_experience: "Wein und Uruguay",
  wine_experience_description:
    "In der Umgebung von Montevideo finden sich zahlreiche preisgekrönte Weingüter, die du nicht missen solltest.",
  ...
  plus_one_name_error: "Der Name ist nicht korrekt",

  email: "E-Mail",
  email_placeholder: "jorge.lopez@example.com",
  email_error: "Die Email-Adresse ist nicht korrekt",

  are_you_comming: "Bestätigung der Teilnahme",
  ...
  countdown_years: "[0] Jahre|[1] Jahr|[+] Jahre",
  countdown_days: "[0] Tage|[1] Tag|[+] Tage",
  countdown_hours: "[0] Stunden|[1] Stunde|[+] Stunden",
  countdown_minutes: "[0] Minuten|[1] Minute|[+] Minuten",
  ...
  travel_uruguay: "Ein gemeinsames Jahr in Uruguay",
