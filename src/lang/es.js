...
Finalmente, muchas gracias a todos los que nos brindaron su ayuda y amor. ¡Estamos muy emocionados de poder compartir este día de fiesta con nuestra gente favorita!"`,
    ...
    ciudad_vieja_description: 'La Ciudad Vieja es el casco antiguo de Montevideo. En la actualidad, es también un barrio. Alberga numerosas empresas, ministerios y oficinas estatales, bancos, museos, galerías de arte y centros culturales, así como restaurantes, discotecas, y bares.',
    ...
    el_club_del_pan_description: 'Quien quiera un café bien preparado (raro en Uruguay), puede desayunar o merendar acá y luego salir a caminar por la rambla, ubicado en pleno Parque Rodó.',
    ...
    rsvp_can_not_be_sent_anymore: 'La fecha límite para enviar el formulario ya fue alcanzada, intenta comunicarte con alguno de los contactos de más arriba.',
